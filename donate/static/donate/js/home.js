      ...
      $("#register_form").css('display','none');
        ...
        if(list == "Select Blood Group"){
            ...
            if(city == ""){
                ...
                var url = "http://boond.pythonanywhere.com/users/results?city="+city
                $.ajax({
                    url : url,
            ...
            gnum++;
            console.log(gnum)
            var url2 = "http://boond.pythonanywhere.com/users/results/group?city="+city+"&group="+gnum;
            $.ajax({
                url : url2,
                success:function(data){
                    $("#hr").css({'display':'block'});
...
$("#info").click(function(){
  ...
  if(ind !=0)
  {
    ...
    $("#s_g").css('display','none');
  url3 = "http://boond.pythonanywhere.com/users/results/group?city="+city+"&group="+ind;
  url4 = "http://boond.pythonanywhere.com/users/results/group/users?city="+city+"&group="+ind;
  $.ajax({
     url : url3,
      success : function(data){
